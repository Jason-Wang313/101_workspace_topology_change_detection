...
\usepackage{url}
\usepackage{booktabs}
\title{Workspace Topology Change Detection: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about robot scene understanding. The original research bet was: Detect topology changes in supports, passages, and occlusions before planning fails. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item Drone-Based Autonomous Motion Planning System for Outdoor Environments under Object Detection Uncertainty (2021)
\item Scene Changes Understanding Framework Based on Graph Convolutional Networks and Swin Transformer Blocks for Monitoring LCLU Using High-Resolution Remote Sensing Images (2022)
\item Integrating foundation models with change detection to identify tasking for service robots (2026)
\item Visual Scene Understanding-Based Task Planning for an Efficient Multipurpose Agricultural Robot System (2025)
\item Robust Task Planning via Failure Detection Using Scene Graph From Multi-View Images (2026)
\end{itemize}
