...
Honest strongest claim: `Detect topology changes in supports, passages, and occlusions before planning fails.` is a plausible branch-structured mechanism for robot scene understanding, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
