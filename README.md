...
This repository contains a hardened, honest workshop-only robotics paper draft for `workspace_topology_change_detection`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/101.pdf`
